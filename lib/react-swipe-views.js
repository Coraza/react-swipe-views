(function (global, factory) {
  ...
  var SwipeViews = (function (_React$Component) {
    ...
    function SwipeViews(props) {
      ...
      var pageWidthPerCent = 100 / numChildren;
    ...
    _createClass(SwipeViews, [{
      ...
      value: function render() {
        ...
        var swipeViewsStyle = {
          ...
          width: _React["default"].Children.count(this.props.children) * 100 + '%'
        };
        ...
        return _React["default"].createElement(
          ...
          _React["default"].createElement(
            "header",
            { className: "SwipeViewsHeader", id: "SwipeViewsHeader" },
            _React["default"].createElement(
              "div",
              ...
              _React["default"].createElement("div", { className: "SwipeViewsInk", id: "SwipeViewsInk", style: swipeViewsInkStyle })
            )
          ),
          _React["default"].createElement(
            "div",
      ...
      value: function _transitionTo(selectedIndex) {
        ...
        var child = _React["default"].Children.map(this.props.children, function (child) {
          return child;
        })[selectedIndex];
        var to = child.props.title.props.to;
      ...
      value: function _handleTouchMove(event) {
        ...
        var numChildren = _React["default"].Children.count(this.props.children);
        var dxPerCent = dx / (this.state.pageWidth * numChildren) * 100;
        var translation = this.state.translation - dxPerCent;
        var maxTranslation = this.state.pageWidthPerCent * (numChildren - 1);
      ...
      value: function _handleClick(selectedIndex, event) {
        ...
        var left = document.getElementById("tab-id" + selectedIndex).offsetLeft;
        ...
        var sLeft = parseInt(left * 2 / document.body.clientWidth);
